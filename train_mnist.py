...
flags.DEFINE_string('model', 'fourier_mnist', 'Model names: fourier_mnist, fourier_mixer, fourier_mixer_shift_invarinat ')
...
def main(argv):
  ...
  l = equ_testter.get_equivarience_error(dm.test_dataloader(),[i for i in range(8,29,1)], mode=FLAGS.data_downscale_mode)
