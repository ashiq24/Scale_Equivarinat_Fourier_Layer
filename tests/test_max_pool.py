...
class Testpool(unittest.TestCase):
  def test_equivarinace(self):
    ...
    layer = scaleEqNonlinMaxp(torch.relu, lowest_scale, max_res=global_modes, pool_window=pool_size, increment=1)
    ...
    scale_range = [i for i in range(lowest_scale,global_modes+1,pool_size)]
