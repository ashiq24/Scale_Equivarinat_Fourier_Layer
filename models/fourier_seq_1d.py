...
from layers.spectral_conv import  SpectralConvLocalized1d 
from layers.spectral_mixer import SpectralMixer_1D
from layers.spectral_mlp import spectralMlp
from layers.scalq_eq_nonlin import scaleEqNonlin1d
...
class FourierSeq1d(AbstractBaseClassifierModel):
  ...
  def forward(self, x):
    ...
    x_ft = torch.fft.fft(x, norm = 'forward').to( self.device, dtype = self.L0.L.dtype)
